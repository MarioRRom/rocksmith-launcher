...
RunCli(0 runtime list)
if (NOT LAST_OUTPUT MATCHES "steam-proton-proton-test")
    message(FATAL_ERROR "The Steam Proton runtime was not discovered")
endif()

RunCli(0 profile new test-profile)
RunCli(0 runtime set test-profile steam-proton-proton-test)
RunCli(0 profile show test-profile)
if (NOT LAST_OUTPUT MATCHES "Runtime: steam-proton-proton-test")
    message(FATAL_ERROR "The selected runtime was not saved to the profile")
endif()
